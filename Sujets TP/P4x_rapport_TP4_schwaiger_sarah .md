...
![table obj](./TP4/capture_ecran/table_obj.png)
...
![screen pas bug](./TP4/capture_ecran/console_log_obj_pos_dans_fonction.png)
...
![table mesh](./TP4/capture_ecran/table_mesh.png)
...
![cibles](./TP4/capture_ecran/vu_chamboule_camera_balle.png)
...
![cibles survol](./TP4/capture_ecran/passage_souris_box_rouge.png)
...
![balle direction](./TP4/capture_ecran/lancement_balle_direction.png)
...
|:------------------:|:------------------:|
|![avant col](./TP4/capture_ecran/avant_collision.png)|![après col](./TP4/capture_ecran/apres_collision.png)|
...
|:------------------:|:------------------:|
|![pousse cible](./TP4/capture_ecran/pousse_hors_table.png)|![pousse cible 2](./TP4/capture_ecran/pousse_hors_table_sans_gravite.png)|
...
![pousse cible g](./TP4/capture_ecran/pousse_hors_table_avec_gravite_1.png)
...
![pousse cible g](./TP4/capture_ecran/pousse_hors_table_avec_gravite_2.png)
...
![pousse cible g](./TP4/capture_ecran/balle_roule_table.png)
